...
echo"<legend class='leg' style='color:#FFF'>LABORATORIOS RECEPTORES</legend>";
...
<br>
<ul class="center5">
<a href="../reportespdf/todo_lab_pdf.php" target="_blank"> <input type="submit" class="vertical" id="imprimir" name="imprimir" value="Imprimir"/></a>

<input type="submit"  class="vertical" id="cancel" name="cancel" value="Volver" onClick="location.href='reporte_laboratorio.php'"/>
</ul>
</td>
</div>
</div>
