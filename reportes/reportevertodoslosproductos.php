...
echo"<legend class='leg' style='color:#FFF'>INVENTARIO PRODUCTOS</legend>";
...
echo"<th>Codigo de Producto</th>";
	...
	echo"</tr></thead>";
	  ...
	  $consulta ="SELECT insumo.cod_i, insumo.descripcion, presentacion.clase_presentacion, insumo.tipo_p, insumo.almacen, insumo.observacion, insumo.n_cantidad  FROM insumo,presentacion  WHERE insumo.presentacion= presentacion.cod_presentacion ORDER BY cod_i ASC";
...
<br>
<ul class="center5">
<a href="../reportespdf/todo_producto_pdf.php" target="_blank"><input type="submit" class="vertical" id="imprimir" name="imprimir" value="Imprimir"/></a>
<input type="submit"  class="vertical" id="cancel" name="cancel" value="Volver" onclick="location.href='reporte_inventario.php'"/>
</ul>
</form>
</div>
</div>
