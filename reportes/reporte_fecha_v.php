...
<legend class="leg" align="center" style="color:#FFF">Productos Por Fecha de Vencimiento</legend>
...
<table>
  ...
  $buscar="SELECT insumo.descripcion, existencia.fecha_v, existencia.lote  FROM insumo, existencia ORDER BY existencia.fecha_v ASC";
$tabla=mysql_query($buscar);
	...
	echo "<tbody><tr><td>".$row["descripcion"]."</td><td>".$fecha[$i]."</td><td>".$row["lote"]."</td></tr><tbody>";
	}
