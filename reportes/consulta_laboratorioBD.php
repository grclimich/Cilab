...
<?php
 ...
 $laboratorio->cod_r=$_REQUEST['cod_r'];
  ...
  if($_REQUEST['consultar']){
	 ...
	 if($num==0){
	  echo "<META HTTP-EQUIV='refresh' CONTENT='0; URL=FORMULARIO_LABORATORIO.php'>";	//Envio hacia Incluir   
	   echo "<script> alert('Laboratorio no registrado por favor Vuelva a Consultar...') </script>";	
	 }	
	
	 else{	 
	 echo "<META HTTP-EQUIV='refresh' CONTENT='0; URL=laboratorio_modificar.php'>"; //Envio hacia Modificar	 
