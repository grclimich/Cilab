 ...
 $login->pass=$pass;
  ...
  if($_REQUEST['Iniciar_Sesion']){
	 ...
	 $num=$login->contar();//cuenta cuantos filas me devolvio la BD
	  ...
	  if($num==0){
	  echo "<META HTTP-EQUIV='refresh' CONTENT='0; URL=CILAB.php'>";	//Envio hacia Incluir   
	   echo "<script> alert('Usuario no registrado') </script>";	
	 }
	 else{	 
	 echo "<META HTTP-EQUIV='refresh' CONTENT='0; URL=cilab/menu/menu2.php'>"; //Envio hacia Modificar	 
