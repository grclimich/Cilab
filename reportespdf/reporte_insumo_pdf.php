...
<?php
	...
	require"consulta_insumo.php";
	$_SESSION['tipo2']=$_SESSION['tipo'];
...
$pdf->SetTitle('tabla de valores por sectores, zonificacion y zona ');
...
$html = $objConsulta->reportePdfInsumo();
$pdf->writeHTMLCell($w=0, $h=0, $x='', $y='', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);

$pdf->Output('Reporte Producto.pdf', 'I');
?>
