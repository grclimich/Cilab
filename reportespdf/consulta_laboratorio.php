...
require "../BD.php";
		...
		$conexion= new conexion();			$conexion-> conectar();	
			...
			function reportePdflaboratorio(){			
			$html="";
			$consulta=mysql_query("SELECT cod_r, nombre_2, direccion, municipio, telefono, nro_fax, nro_rif FROM laboratorio_receptor ORDER BY nombre_2 ASC");$i=0;
